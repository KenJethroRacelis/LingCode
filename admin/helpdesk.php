...
// 1. Authorization Guard: Keep out unauthorized sessions, regular student users, and moderators
...
<head>
    <meta charset="UTF-8">
    <title>System Helpdesk & Admin FAQ | System Admin Portal</title>
    ...
    <style>
        ...
        .hero {
            ...
            text-align: center;
            padding: 50px 20px;
            border-bottom: 4px solid #c0392b; /* Admin specific dark red dividing line */
        }
        ...
        .faq-card:hover {
            ...
            border-left-color: #c0392b; /* Highlights admin crimson on focus */
        }
        ...
        .contact-box {
            ...
            text-align: center;
            margin-top: 40px;
            border-top: 4px solid #c0392b; /* Admin specific crimson bounding accent */
        }
...
<header>
    ...
    <nav>
        ...
        <a href="helpdesk.php" style="color: #ff6060;">Helpdesk</a>
...
<section class="hero">
    <h1>System Helpdesk & Admin FAQ</h1>
    <p>Administrative Knowledge Base — Operating your system admin portal console</p>
...
<div class="container-helpdesk">
    ...
    <div class="faq-card">
        ...
        <p>
            On your main <strong>System Queue Console</strong> dashboard, click the blue **Respond** action item on any active card. You will be routed to the ticket management profile page where you can input detailed operational updates, manage admin notices, and alter tracking configurations.
        </p>
    </div>
    ...
    <div class="faq-card">
        ...
        <p>
            Yes. The moment you submit a progress report, switch a tracking status, or visibility flags via your configuration forms, the variables commit immediately onto the data tables. Residents will observe the modifications live upon viewing their respective accounts.
        </p>
    </div>
