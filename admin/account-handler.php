...
// 1. Authorization Guard: Ensure only administrators hit this processing endpoint
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action_type === 'update_password') {
        ...
        // Fetch admin user's current hashed password from database
...
// Redirect back to main profile interface page if accessed via arbitrary URL GET method
