...
// 1. Authorization Guard: Stop logged-out traffic, regular users, or mods from entering this file
...
<head>
    <meta charset="UTF-8">
    <title>Community Forum Administration | System Console</title>
    ...
    <style>
        ...
        .card-forum { 
            ...
            border-left: 5px solid #c0392b; /* Admin context signature accent line */
            display: flex;
            flex-direction: column;
...
<header>
    ...
    <nav>
        ...
        <a href="forum.php" style="color: #ff6060;">Community Forum</a>
...
<div class="forum-title-section">
    <h1>Community Forum Administration</h1>
    <p>Oversee pending requests and send to the dashboard for further edits</p>
</div>
