...
// 1. Authorization Guard: Ensure only moderators access this panel
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'mod') {
    header("Location: ../index.php");
    exit();
}

// 2. Fetch current staff profile data to populate inputs
...
<head>
    <meta charset="UTF-8">
    <title>Manage Staff Account | Landlord Core Engine</title>
    ...
    <style>
        ...
        .account-card.accent {
            border-top-color: #e67e22; /* Moderator Orange accent boundary line */
        }
...
<header>
    ...
    <nav>
        ...
        <a href="account.php" style="color: #e67e22; border-left: 1px solid #7f8c8d; padding-left: 15px;">
...
<div class="container-account">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success">🎉 Staff profile configuration applied successfully.</div>
    ...
    <div class="account-card danger-zone">
        ...
        <p style="color:#7f8c8d; font-size:0.95rem; margin-top:0;">
            Ready to close the land management console? Ensure all response logs have been saved before exiting.
        </p>
