...
// 1. Authorization Guard: Ensure only moderators hit this processing endpoint
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action_type === 'update_password') {
        ...
        // Fetch staff user's current hashed password from database
...
// Redirect back to main page if accessed via arbitrary URL GET method
