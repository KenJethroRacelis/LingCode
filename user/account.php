...
// 2. Fetch current profile data to populate inputs
...
<head>
    <meta charset="UTF-8">
    <title>Manage Account | LingCode</title>
...
<header>
    ...
    <nav>
        ...
        <a href="account.php" style="color: #d4af37; border-left: 1px solid #7f8c8d; padding-left: 15px;">
...
<div class="container-account">
    ...
    <?php if (isset($_GET['success'])): ?>
        <div class="alert alert-success">🎉 Account changes applied successfully.</div>
    <?php elseif (isset($_GET['error'])): ?>
        <div class="alert alert-danger">
            <?php
                switch($_GET['error']) {
                    case 'wrong_password': echo "❌ Incorrect current password verified."; break;
                    case 'password_mismatch': echo "❌ New password verification match failed."; break;
                    case 'empty': echo "❌ Required field entries cannot be blank."; break;
                    default: echo "❌ System processing failure. Please contact support.";
                }
            ?>
        </div>
    <?php endif; ?>
    ...
    <div class="account-card">
        ...
        <form action="account-handler.php" method="POST">
            ...
            <input type="text" id="contact" name="contact" value="<?php echo htmlspecialchars($user_data['contact'] ?? ''); ?>" placeholder="e.g., 09123456789">

            <label for="address">Room / Building Address</label>
            <input type="text" id="address" name="address" value="<?php echo htmlspecialchars($user_data['address'] ?? ''); ?>" placeholder="e.g., Galaxy Street, Room 204-B">
    ...
    <div class="account-card accent">
        ...
        <form action="account-handler.php" method="POST">
            ...
            <button type="submit" class="btn-save btn-warn">Update System Password</button>
        </form>
    </div>
    ...
    <div class="account-card danger-zone">
        ...
        <p style="color:#7f8c8d; font-size:0.95rem; margin-top:0;">
            Ready to end your session? Make sure all your outstanding maintenance logs have been successfully submitted.
        </p>
        <a href="logout.php" class="btn-danger">Log Out of Portal</a>
    </div>
